...
export function IconBadgeLetter({ style, className, letter, color, fontFamily, x, y }: Params) {

    return (
        <svg style={style} className={className} width="40" height="40" viewBox="0 0 24 24" strokeWidth="1" stroke="#000000" fill="none"
